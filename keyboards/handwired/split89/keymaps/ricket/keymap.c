...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
      ...
      KC_LCTL, KC_LGUI,KC_LALT,MO(1),  KC_SPACE,KC_SPACE,KC_RALT,KC_RGUI, KC_APP,  KC_RCTL, KC_LEFT,  KC_DOWN, KC_RGHT
        ),
    /* AUD */
    [1] = LAYOUT(
      KC_TRNS, KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_TRNS,   KC_TRNS,KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,   KC_TRNS, KC_TRNS, KC_TRNS, NK_TOGG,
